...
function ModalProductDetail ({navigation, title})  {
    return(
        <>
            <View className={"modal  pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center"}>
                <View className={"modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto"}>
                    ...
                    <View className={"modal-content bg-white py-4 text-left px-6"}>
                        ...
                        <View class={"flex justify-end pt-2"}>
                            <Button title={"Action"} className={"px-4 bg-transparent p-3 rounded-lg text-indigo-500 hover:bg-gray-100 hover:text-indigo-400 mr-2"}></Button>
